...
class Proveedor {
  ...
  factory Proveedor.fromMap(Map<String, dynamic> json) => Proveedor(
        listado:
            List<List_proveedor>.from(json["Proveedores Listado"].map((x) => List_proveedor.fromMap(x))),
      );
...
class List_proveedor {
  ...
  factory List_proveedor.fromJson(String str) => List_proveedor.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory List_proveedor.fromMap(Map<String, dynamic> json) => List_proveedor(
  ...
  List_proveedor copy() => List_proveedor(
